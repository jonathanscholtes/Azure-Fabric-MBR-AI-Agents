"""MCP tool: list_decks — enumerate generated deck metadata blobs."""
...
logger = logging.getLogger("presentation-tools.library")
...
def register_library_tools(mcp) -> None:
    ...
    @mcp.tool()
    def list_decks(region: str | None = None, period: str | None = None) -> list[dict]:
        """List previously generated presentation decks from deck metadata blobs.
